 ...
 class Bar{
    ...
    // 자바수업에서 무언가 없던 새로운게 있다고 착각하지 말자!!
     ...
     //객체가 보유한 변수들을 이용하여 원하는 변화를 주면, 움직임을 표현 가능
     //즉 움직임 방식을 결정할 수 있는 객체 안에 함수를 가리켜 메서드(method)
     render(){  // 화면에 보여질 처리--> 게임분야에선 렌더링이라고 함!
        //물체위치=기존 물체위치+비율*(남은거리(목표지점-기존 위치))
